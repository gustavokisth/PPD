                         ...
                         q7_t * bufferB)
{
    ...
    #pragma omp parallel for simd private(i, j, k, l, m, n, conv_out, in_row, in_col) num_threads(numThreads) //omp paralelo para loop for em SIMD com variáveis privadas
#endif
    for (i = 0; i < ch_im_out; i++)
    {
